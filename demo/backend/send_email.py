...
def generate_email_content():
    ...
    """
    prompt = """
아래 조건에 맞춰, 친근하고 유머러스한 말투로 이메일 제목과 본문을 작성해줘. 이메일은 각 팀원에게 동료들이 평가한 '동료 피드백 보고서' 파일을 첨부하여 전달하는 내용이야.
...
4. 이메일 본문:
   ...
   - 첨부 파일(동료 피드백 보고서)이 포함되었음을 명시할 것.
...
5. 작성 예시:
[이메일 제목]
{name}님, 동료 피드백 보고서 도착했어요! 💌

[이메일 본문]
안녕하세요, {name}님!!
오늘도 좋은 하루 보내고 계신가요?

첨부된 파일은 팀원들이 보내주신 동료 피드백 보고서입니다!
