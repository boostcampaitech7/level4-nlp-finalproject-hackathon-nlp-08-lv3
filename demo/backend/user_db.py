...
def seed_users_data():
    ...
    if user_count == 0:
        users_data = [
            ...
            (6, 'user5', '정주현', 'user123', 'user', 1, '팀원','2025-01-14 08:00:00'),
            (7, 'user6', '임경현', 'user123', 'user', 2, '팀장','2025-01-14 08:00:00'),
            (8, 'user7', '이유경', 'user123', 'user', 2, '팀원', '2025-01-14 08:00:00'),
            (9, 'user8', '박장원', 'user123', 'user', 2, '팀원', '2025-01-14 08:00:00'),
            (10, 'user9', '오여진', 'user123', 'user', 3, '팀장','2025-01-14 08:00:00'),
            (11, 'user10', '김소정', 'user123', 'user', 3, '팀원','2025-01-14 08:00:00'),
            (12, 'user11', '유주리', 'user123', 'user', 3, '팀원', '2025-01-14 08:00:00')
        ]
